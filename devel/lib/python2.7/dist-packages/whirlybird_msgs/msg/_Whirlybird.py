...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_9f().pack(_x.roll, _x.pitch, _x.yaw, _x.accel_x, _x.accel_y, _x.accel_z, _x.gyro_x, _x.gyro_y, _x.gyro_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.roll, _x.pitch, _x.yaw, _x.accel_x, _x.accel_y, _x.accel_z, _x.gyro_x, _x.gyro_y, _x.gyro_z,) = _get_struct_9f().unpack(str[start:end])
      return self
